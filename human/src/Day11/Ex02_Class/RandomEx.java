...
//		System.out.println(randomTF);
		...
		//4byte범위 (-21억xx~21억xx)사이의 난수를 반환
		int fourByteRadom = random.nextInt();
		System.out.println("4바이트 랜덤 정수: "+fourByteRadom);
		...
		System.out.println("실수랜덤수 : "+randomDouble);
