...
public class DateTimeCompareEx {
	public static void main(String[] args) {
		//2022년 11월 19일 9시 0분 0초
		LocalDateTime startDateTime = LocalDateTime.of(2022, 11,10,9,0,0);
		System.out.println("시작일: "+ startDateTime);

		//2023년 06월 29일 18시 0분 0초
		LocalDateTime endDateTime = LocalDateTime.of(2023, 06,29,9,0,0);
		...
		// 시간순으로 이전/일치/이후 확인하여 여부를 true,false로 반환하는 메소드
		...
		//until()
		//:LocalDateTime 객체의 날짜/시간부터 인자로 지정한 객체까지 날짜/시간까지
		// 남은 시간을 반환하는 메소드
		...
		System.out.println("남은 개월수: "+remainMonth);
